    ...
    <div class="background">
        ...
        <div class="bottom-part">
            ...
            <el-table stripe border :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="date" label="文章标题" width="200" align="center" />
                <el-table-column prop="date" label="文章内容" width="400" align="center" />
    ...
    <el-dialog v-model="appendDialogVisible" title="新增文章" width="500">
        <el-form :model="appendForm" label-width="auto" style="max-width: 600px">
            <el-form-item required label="标题">
                <el-input v-model="appendForm.name" placeholder="请输入标题" />
            </el-form-item>
            <el-form-item required label="内容">
                <el-input type="textarea" v-model="appendForm.name" placeholder="请输入内容" />
            </el-form-item>
        </el-form>
        <template #footer>
...
const userInfo = ref({ name: 'kooriookami', email: 'xxxx@xxxx.com', balance: 1000, birthday: '1999-01-01' })
